...
class _UserService implements UserService {
  ...
  @override
  Future<List<User>> getProfile(String key) async {
  ...
  @override
  Future<User> getToken(RequestLogout requestLogout) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = requestLogout;
    final _result =
  ...
  @override
  Future<Absent> getLogout(RequestLogout requestLogout) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = requestLogout;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Absent>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = Absent.fromJson(_result.data!);
    return value;
  }
  ...
  Future<List<Login>> login(
    ...
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<Login>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/x-www-form-urlencoded',
  ...
  @override
  Future<List<User>> getProfileUser(String key) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'key': key};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
