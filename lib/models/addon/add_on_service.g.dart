...
class _AddOnRestInterface implements AddOnRestInterface {
  _AddOnRestInterface(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<List<AddOn>> gets(
    ...
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<AddOn>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => AddOn.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
